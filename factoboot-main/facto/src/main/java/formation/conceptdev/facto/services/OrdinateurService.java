...
import formation.conceptdev.facto.repositories.IDAOOrdinateur;
...
public class OrdinateurService {
	...
	public List<Ordinateur> searchByNom(String nom) {
	    return daoOrdinateur.findByNomContaining(nom);
	}
