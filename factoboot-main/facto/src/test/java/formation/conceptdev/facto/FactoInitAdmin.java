	...
	void Ajout_Base()
	{
		     ...
		     // ajout données Stagiaires
		        for (int i = 1; i <= 100; i++) 
		        {
		            ...
		            Utilisateur utilisateur = new Utilisateur("login" + i, "admin", "nom" + i, "prenom" + i, "email" + i+"@mail"+i+".com",stagiaire,Role.ROLE_STAGIAIRE);
		        ...
		        for (int i = 101; i <= 105; i++) {
		            Utilisateur utilisateur = new Utilisateur("login" + i, "admin", "nom" + i, "prenom" + i, "email" + i+"@mail"+i+".com",Role.ROLE_ADMINISTRATEUR);
		            utilisateurService.create(utilisateur);
		        }
		        
		        // ajout données Utilisateurs
		        for (int i = 106; i <= 110; i++) {
		            Utilisateur utilisateur = new Utilisateur("login" + i, "admin", "nom" + i, "prenom" + i, "email" + i+"@mail"+i+".com",Role.ROLE_GESTIONNAIRE);
		            utilisateurService.create(utilisateur);
		        }
		        
		     // ajout données Utilisateurs
		        for (int i = 111; i <= 115; i++) {
		            Utilisateur utilisateur = new Utilisateur("login" + i, "admin", "nom" + i, "prenom" + i, "email" + i+"@mail"+i+".com",Role.ROLE_TECHNICIEN);
		            utilisateurService.create(utilisateur);
		        }
		        ...
		        for (int i = 116; i <= 126; i++) {
		            ...
		            Utilisateur utilisateur = new Utilisateur("login" + i, "admin", "nom" + i, "prenom" + i, "email" + i+"@mail"+i+".com",formateur,Role.ROLE_FORMATEUR);
		            utilisateurService.create(utilisateur);
